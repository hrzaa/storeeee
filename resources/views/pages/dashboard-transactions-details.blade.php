                    ...
                    <div class="col-12 col-md-8">
                      ...
                      <div class="row">
                        <div class="col-12 col-md-6">
                          ...
                          <div class="product-subtitle">${{ number_format($transaction->total_price) }}</div>
                        </div>
                        <div class="col-12 col-md-6">
                      ...
                      <div class="col-12">
                        ...
                        <div class="row">
                          <div class="col-12 col-md-6">
                            ...
                            <div class="product-subtitle">{{ App\Models\Regency::find($transaction->transaction->user->zip_code) }}</div>
                          </div>
                          <div class="col-12 col-md-6">
                            <div class="product-title">Country</div>
                            <div class="product-subtitle">{{ App\Models\Regency::find($transaction->transaction->user->country) }}</div>
                          </div>
